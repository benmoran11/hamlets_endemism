...
#PBS -N nFmaypue2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_maypue2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_maypue2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue2_may_noFstPeaks.msmc -I 2,3,10,11 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue2_pue_noFstPeaks.msmc -I 28,29,32,33 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue2_cross_noFstPeaks.msmc -I 2,3,10,11,28,29,32,33 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py maypue2_cross_noFstPeaks.msmc.final.txt maypue2_may_noFstPeaks.msmc.final.txt maypue2_pue_noFstPeaks.msmc.final.txt > combined_maypue2_noFstPeaks_msmc.final.txt
