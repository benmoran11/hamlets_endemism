...
#PBS -N nFnigpue2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_nigpue2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_nigpue2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue2_nig_noFstPeaks.msmc -I 4,5,6,7 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue2_pue_noFstPeaks.msmc -I 32,33,36,37 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue2_cross_noFstPeaks.msmc -I 4,5,6,7,32,33,36,37 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py nigpue2_cross_noFstPeaks.msmc.final.txt nigpue2_nig_noFstPeaks.msmc.final.txt nigpue2_pue_noFstPeaks.msmc.final.txt > combined_nigpue2_noFstPeaks_msmc.final.txt
