...
#PBS -N nFpueuni2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_pueuni2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_pueuni2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni2_pue_noFstPeaks.msmc -I 8,9,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni2_uni_noFstPeaks.msmc -I 26,27,28,29 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni2_cross_noFstPeaks.msmc -I 8,9,12,13,26,27,28,29 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py pueuni2_cross_noFstPeaks.msmc.final.txt pueuni2_pue_noFstPeaks.msmc.final.txt pueuni2_uni_noFstPeaks.msmc.final.txt > combined_pueuni2_noFstPeaks_msmc.final.txt
