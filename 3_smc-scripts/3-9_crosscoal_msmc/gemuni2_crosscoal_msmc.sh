...
#PBS -N gemuni2                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_gemuni2.stdout
#PBS -e 3.9.1.crosscoal_msmc_gemuni2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni2_gem.msmc -I 0,1,8,9 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni2_uni.msmc -I 12,13,14,15 \
    $INDIR/LG01.gemuni.multihetsep.txt \
    $INDIR/LG02.gemuni.multihetsep.txt \
    $INDIR/LG03.gemuni.multihetsep.txt \
    $INDIR/LG04.gemuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni2_cross.msmc -I 0,1,8,9,12,13,14,15 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemuni.multihetsep.txt \
    $INDIR/LG02.gemuni.multihetsep.txt \
    $INDIR/LG03.gemuni.multihetsep.txt \
    $INDIR/LG04.gemuni.multihetsep.txt \
...
combineCrossCoal.py gemuni2_cross.msmc.final.txt gemuni2_gem.msmc.final.txt gemuni2_uni.msmc.final.txt > combined_gemuni2_msmc.final.txt
