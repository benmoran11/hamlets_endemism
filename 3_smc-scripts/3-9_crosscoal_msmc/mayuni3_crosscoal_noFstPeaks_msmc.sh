...
#PBS -N nFmayuni3                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_mayuni3.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_mayuni3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni3_may_noFstPeaks.msmc -I 8,9,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni3_uni_noFstPeaks.msmc -I 26,27,38,39 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni3_cross_noFstPeaks.msmc -I 8,9,16,17,26,27,38,39 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py mayuni3_cross_noFstPeaks.msmc.final.txt mayuni3_may_noFstPeaks.msmc.final.txt mayuni3_uni_noFstPeaks.msmc.final.txt > combined_mayuni3_noFstPeaks_msmc.final.txt
