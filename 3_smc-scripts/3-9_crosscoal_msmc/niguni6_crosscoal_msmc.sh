...
#PBS -N niguni6                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_niguni6.stdout
#PBS -e 3.9.1.crosscoal_msmc_niguni6.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni6_nig.msmc -I 2,3,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni6_uni.msmc -I 32,33,34,35 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni6_cross.msmc -I 2,3,16,17,32,33,34,35 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
combineCrossCoal.py niguni6_cross.msmc.final.txt niguni6_nig.msmc.final.txt niguni6_uni.msmc.final.txt > combined_niguni6_msmc.final.txt
