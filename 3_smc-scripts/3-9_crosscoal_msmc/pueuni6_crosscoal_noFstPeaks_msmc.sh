...
#PBS -N nFpueuni6                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_pueuni6.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_pueuni6.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni6_pue_noFstPeaks.msmc -I 10,11,14,15 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni6_uni_noFstPeaks.msmc -I 32,33,34,35 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni6_cross_noFstPeaks.msmc -I 10,11,14,15,32,33,34,35 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py pueuni6_cross_noFstPeaks.msmc.final.txt pueuni6_pue_noFstPeaks.msmc.final.txt pueuni6_uni_noFstPeaks.msmc.final.txt > combined_pueuni6_noFstPeaks_msmc.final.txt
