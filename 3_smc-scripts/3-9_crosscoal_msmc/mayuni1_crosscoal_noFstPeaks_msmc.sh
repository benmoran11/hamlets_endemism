...
#PBS -N nFmayuni1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_mayuni1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_mayuni1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni1_may_noFstPeaks.msmc -I 4,5,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni1_uni_noFstPeaks.msmc -I 34,35,40,41 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni1_cross_noFstPeaks.msmc -I 4,5,12,13,34,35,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py mayuni1_cross_noFstPeaks.msmc.final.txt mayuni1_may_noFstPeaks.msmc.final.txt mayuni1_uni_noFstPeaks.msmc.final.txt > combined_mayuni1_noFstPeaks_msmc.final.txt
