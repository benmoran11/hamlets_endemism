...
#PBS -N maypue4                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maypue4.stdout
#PBS -e 3.9.1.crosscoal_msmc_maypue4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue4_may.msmc -I 0,1,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue4_pue.msmc -I 20,21,36,37 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue4_cross.msmc -I 0,1,18,19,20,21,36,37 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
combineCrossCoal.py maypue4_cross.msmc.final.txt maypue4_may.msmc.final.txt maypue4_pue.msmc.final.txt > combined_maypue4_msmc.final.txt
