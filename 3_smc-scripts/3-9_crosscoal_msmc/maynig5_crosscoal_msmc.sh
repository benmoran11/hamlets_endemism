...
#PBS -N maynig5                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maynig5.stdout
#PBS -e 3.9.1.crosscoal_msmc_maynig5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig5_may.msmc -I 6,7,14,15 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig5_nig.msmc -I 28,29,32,33 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig5_cross.msmc -I 6,7,14,15,28,29,32,33 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
combineCrossCoal.py maynig5_cross.msmc.final.txt maynig5_may.msmc.final.txt maynig5_nig.msmc.final.txt > combined_maynig5_msmc.final.txt
