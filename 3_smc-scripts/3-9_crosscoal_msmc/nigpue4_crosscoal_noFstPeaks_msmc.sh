...
#PBS -N nFnigpue4                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_nigpue4.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_nigpue4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue4_nig_noFstPeaks.msmc -I 0,1,22,23 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue4_pue_noFstPeaks.msmc -I 30,31,42,43 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue4_cross_noFstPeaks.msmc -I 0,1,22,23,30,31,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py nigpue4_cross_noFstPeaks.msmc.final.txt nigpue4_nig_noFstPeaks.msmc.final.txt nigpue4_pue_noFstPeaks.msmc.final.txt > combined_nigpue4_noFstPeaks_msmc.final.txt
