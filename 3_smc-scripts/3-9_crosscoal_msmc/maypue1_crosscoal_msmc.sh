...
#PBS -N maypue1                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maypue1.stdout
#PBS -e 3.9.1.crosscoal_msmc_maypue1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue1_may.msmc -I 4,5,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue1_pue.msmc -I 24,25,36,37 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue1_cross.msmc -I 4,5,12,13,24,25,36,37 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
combineCrossCoal.py maypue1_cross.msmc.final.txt maypue1_may.msmc.final.txt maypue1_pue.msmc.final.txt > combined_maypue1_msmc.final.txt
