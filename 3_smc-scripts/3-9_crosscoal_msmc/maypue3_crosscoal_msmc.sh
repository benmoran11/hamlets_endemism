...
#PBS -N maypue3                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maypue3.stdout
#PBS -e 3.9.1.crosscoal_msmc_maypue3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_may.msmc -I 8,9,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_pue.msmc -I 22,23,42,43 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_cross.msmc -I 8,9,16,17,22,23,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
combineCrossCoal.py maypue3_cross.msmc.final.txt maypue3_may.msmc.final.txt maypue3_pue.msmc.final.txt > combined_maypue3_msmc.final.txt
