...
#PBS -N pueuni1                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_pueuni1.stdout
#PBS -e 3.9.1.crosscoal_msmc_pueuni1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni1_pue.msmc -I 4,5,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni1_uni.msmc -I 38,39,44,45 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni1_cross.msmc -I 4,5,16,17,38,39,44,45 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
combineCrossCoal.py pueuni1_cross.msmc.final.txt pueuni1_pue.msmc.final.txt pueuni1_uni.msmc.final.txt > combined_pueuni1_msmc.final.txt
