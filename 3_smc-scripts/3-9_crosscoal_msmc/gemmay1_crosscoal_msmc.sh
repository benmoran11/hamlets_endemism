...
#PBS -N gemmay1                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_gemmay1.stdout
#PBS -e 3.9.1.crosscoal_msmc_gemmay1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay1_gem.msmc -I 2,3,4,5 \
    $INDIR/LG01.gemmay.multihetsep.txt \
    $INDIR/LG02.gemmay.multihetsep.txt \
    $INDIR/LG03.gemmay.multihetsep.txt \
    $INDIR/LG04.gemmay.multihetsep.txt \
    $INDIR/LG05.gemmay.multihetsep.txt \
    $INDIR/LG06.gemmay.multihetsep.txt \
    $INDIR/LG07.gemmay.multihetsep.txt \
    $INDIR/LG08.gemmay.multihetsep.txt \
    $INDIR/LG09.gemmay.multihetsep.txt \
    $INDIR/LG10.gemmay.multihetsep.txt \
    $INDIR/LG11.gemmay.multihetsep.txt \
    $INDIR/LG12.gemmay.multihetsep.txt \
    ...
    $INDIR/LG17.gemmay.multihetsep.txt \
    ...
    $INDIR/LG23.gemmay.multihetsep.txt \
    $INDIR/LG24.gemmay.multihetsep.txt
echo done

msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay1_may.msmc -I 14,15,22,23 \
    $INDIR/LG01.gemmay.multihetsep.txt \
    $INDIR/LG02.gemmay.multihetsep.txt \
    $INDIR/LG03.gemmay.multihetsep.txt \
    $INDIR/LG04.gemmay.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay1_cross.msmc -I 2,3,4,5,14,15,22,23 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemmay.multihetsep.txt \
    $INDIR/LG02.gemmay.multihetsep.txt \
    $INDIR/LG03.gemmay.multihetsep.txt \
    $INDIR/LG04.gemmay.multihetsep.txt \
...
combineCrossCoal.py gemmay1_cross.msmc.final.txt gemmay1_gem.msmc.final.txt gemmay1_may.msmc.final.txt > combined_gemmay1_msmc.final.txt
