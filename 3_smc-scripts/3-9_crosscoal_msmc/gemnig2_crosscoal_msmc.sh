...
#PBS -N gemnig2                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_gemnig2.stdout
#PBS -e 3.9.1.crosscoal_msmc_gemnig2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig2_gem.msmc -I 0,1,8,9 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig2_nig.msmc -I 14,15,16,17 \
    $INDIR/LG01.gemnig.multihetsep.txt \
    $INDIR/LG02.gemnig.multihetsep.txt \
    $INDIR/LG03.gemnig.multihetsep.txt \
    $INDIR/LG04.gemnig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig2_cross.msmc -I 0,1,8,9,14,15,16,17 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemnig.multihetsep.txt \
    $INDIR/LG02.gemnig.multihetsep.txt \
    $INDIR/LG03.gemnig.multihetsep.txt \
    $INDIR/LG04.gemnig.multihetsep.txt \
...
combineCrossCoal.py gemnig2_cross.msmc.final.txt gemnig2_gem.msmc.final.txt gemnig2_nig.msmc.final.txt > combined_gemnig2_msmc.final.txt
