...
#PBS -N maynig2                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maynig2.stdout
#PBS -e 3.9.1.crosscoal_msmc_maynig2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_may.msmc -I 2,3,10,11 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
    $INDIR/LG05.maynig.multihetsep.txt \
    $INDIR/LG06.maynig.multihetsep.txt \
    $INDIR/LG07.maynig.multihetsep.txt \
    $INDIR/LG08.maynig.multihetsep.txt \
    $INDIR/LG09.maynig.multihetsep.txt \
    $INDIR/LG10.maynig.multihetsep.txt \
    $INDIR/LG11.maynig.multihetsep.txt \
    $INDIR/LG12.maynig.multihetsep.txt \
    ...
    $INDIR/LG17.maynig.multihetsep.txt \
    ...
    $INDIR/LG23.maynig.multihetsep.txt \
    $INDIR/LG24.maynig.multihetsep.txt
echo done

msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_nig.msmc -I 24,25,26,27 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_cross.msmc -I 2,3,10,11,24,25,26,27 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
combineCrossCoal.py maynig2_cross.msmc.final.txt maynig2_may.msmc.final.txt maynig2_nig.msmc.final.txt > combined_maynig2_msmc.final.txt
