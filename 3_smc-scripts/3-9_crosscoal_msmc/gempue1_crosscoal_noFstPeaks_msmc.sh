...
#PBS -N nFgempue1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_gempue1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_gempue1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue1_gem_noFstPeaks.msmc -I 2,3,4,5 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue1_pue_noFstPeaks.msmc -I 14,15,26,27 \
    $INDIR/LG01.gempue.multihetsep.txt \
    $INDIR/LG02.gempue.multihetsep.txt \
    $INDIR/LG03.gempue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gempue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue1_cross_noFstPeaks.msmc -I 2,3,4,5,14,15,26,27 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gempue.multihetsep.txt \
    $INDIR/LG02.gempue.multihetsep.txt \
    $INDIR/LG03.gempue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gempue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py gempue1_cross_noFstPeaks.msmc.final.txt gempue1_gem_noFstPeaks.msmc.final.txt gempue1_pue_noFstPeaks.msmc.final.txt > combined_gempue1_noFstPeaks_msmc.final.txt
