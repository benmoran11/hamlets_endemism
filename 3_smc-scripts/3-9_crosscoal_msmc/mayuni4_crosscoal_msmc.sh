...
#PBS -N mayuni4                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_mayuni4.stdout
#PBS -e 3.9.1.crosscoal_msmc_mayuni4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni4_may.msmc -I 0,1,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni4_uni.msmc -I 20,21,36,37 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.multihetsep.txt \
    $INDIR/LG04.mayuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni4_cross.msmc -I 0,1,18,19,20,21,36,37 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.multihetsep.txt \
    $INDIR/LG04.mayuni.multihetsep.txt \
...
combineCrossCoal.py mayuni4_cross.msmc.final.txt mayuni4_may.msmc.final.txt mayuni4_uni.msmc.final.txt > combined_mayuni4_msmc.final.txt
