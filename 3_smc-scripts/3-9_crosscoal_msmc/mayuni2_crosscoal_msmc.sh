...
#PBS -N mayuni2                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_mayuni2.stdout
#PBS -e 3.9.1.crosscoal_msmc_mayuni2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_may.msmc -I 2,3,10,11 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_uni.msmc -I 22,23,24,25 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.multihetsep.txt \
    $INDIR/LG04.mayuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_cross.msmc -I 2,3,10,11,22,23,24,25 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.multihetsep.txt \
    $INDIR/LG04.mayuni.multihetsep.txt \
...
combineCrossCoal.py mayuni2_cross.msmc.final.txt mayuni2_may.msmc.final.txt mayuni2_uni.msmc.final.txt > combined_mayuni2_msmc.final.txt
