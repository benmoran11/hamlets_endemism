...
#PBS -N niguni5                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_niguni5.stdout
#PBS -e 3.9.1.crosscoal_msmc_niguni5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni5_nig.msmc -I 8,9,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni5_uni.msmc -I 36,37,46,47 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni5_cross.msmc -I 8,9,12,13,36,37,46,47 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
combineCrossCoal.py niguni5_cross.msmc.final.txt niguni5_nig.msmc.final.txt niguni5_uni.msmc.final.txt > combined_niguni5_msmc.final.txt
