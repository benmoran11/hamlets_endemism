...
#PBS -N maynig4                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maynig4.stdout
#PBS -e 3.9.1.crosscoal_msmc_maynig4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_may.msmc -I 0,1,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_nig.msmc -I 20,21,42,43 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_cross.msmc -I 0,1,18,19,20,21,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
combineCrossCoal.py maynig4_cross.msmc.final.txt maynig4_may.msmc.final.txt maynig4_nig.msmc.final.txt > combined_maynig4_msmc.final.txt
