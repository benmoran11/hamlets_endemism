...
#PBS -N gempue2                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_gempue2.stdout
#PBS -e 3.9.1.crosscoal_msmc_gempue2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue2_gem.msmc -I 0,1,8,9 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue2_pue.msmc -I 18,19,22,23 \
    $INDIR/LG01.gempue.multihetsep.txt \
    $INDIR/LG02.gempue.multihetsep.txt \
    $INDIR/LG03.gempue.multihetsep.txt \
    $INDIR/LG04.gempue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gempue2_cross.msmc -I 0,1,8,9,18,19,22,23 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gempue.multihetsep.txt \
    $INDIR/LG02.gempue.multihetsep.txt \
    $INDIR/LG03.gempue.multihetsep.txt \
    $INDIR/LG04.gempue.multihetsep.txt \
...
combineCrossCoal.py gempue2_cross.msmc.final.txt gempue2_gem.msmc.final.txt gempue2_pue.msmc.final.txt > combined_gempue2_msmc.final.txt
