...
#PBS -N nFgemmay2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_gemmay2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_gemmay2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay2_gem_noFstPeaks.msmc -I 0,1,8,9 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay2_may_noFstPeaks.msmc -I 12,13,20,21 \
    $INDIR/LG01.gemmay.multihetsep.txt \
    $INDIR/LG02.gemmay.multihetsep.txt \
    $INDIR/LG03.gemmay.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemmay.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemmay2_cross_noFstPeaks.msmc -I 0,1,8,9,12,13,20,21 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemmay.multihetsep.txt \
    $INDIR/LG02.gemmay.multihetsep.txt \
    $INDIR/LG03.gemmay.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemmay.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py gemmay2_cross_noFstPeaks.msmc.final.txt gemmay2_gem_noFstPeaks.msmc.final.txt gemmay2_may_noFstPeaks.msmc.final.txt > combined_gemmay2_noFstPeaks_msmc.final.txt
