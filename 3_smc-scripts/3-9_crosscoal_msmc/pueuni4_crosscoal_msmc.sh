...
#PBS -N pueuni4                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_pueuni4.stdout
#PBS -e 3.9.1.crosscoal_msmc_pueuni4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni4_pue.msmc -I 6,7,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni4_uni.msmc -I 24,25,40,41 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni4_cross.msmc -I 6,7,18,19,24,25,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
combineCrossCoal.py pueuni4_cross.msmc.final.txt pueuni4_pue.msmc.final.txt pueuni4_uni.msmc.final.txt > combined_pueuni4_msmc.final.txt
