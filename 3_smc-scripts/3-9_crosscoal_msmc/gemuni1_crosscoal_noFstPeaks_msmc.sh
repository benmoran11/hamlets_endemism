...
#PBS -N nFgemuni1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_gemuni1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_gemuni1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni1_gem_noFstPeaks.msmc -I 2,3,4,5 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni1_uni_noFstPeaks.msmc -I 26,27,30,31 \
    $INDIR/LG01.gemuni.multihetsep.txt \
    $INDIR/LG02.gemuni.multihetsep.txt \
    $INDIR/LG03.gemuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemuni1_cross_noFstPeaks.msmc -I 2,3,4,5,26,27,30,31 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemuni.multihetsep.txt \
    $INDIR/LG02.gemuni.multihetsep.txt \
    $INDIR/LG03.gemuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py gemuni1_cross_noFstPeaks.msmc.final.txt gemuni1_gem_noFstPeaks.msmc.final.txt gemuni1_uni_noFstPeaks.msmc.final.txt > combined_gemuni1_noFstPeaks_msmc.final.txt
