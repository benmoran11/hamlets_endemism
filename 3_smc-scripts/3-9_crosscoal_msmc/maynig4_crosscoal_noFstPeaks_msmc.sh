...
#PBS -N nFmaynig4                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_maynig4.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_maynig4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_may_noFstPeaks.msmc -I 0,1,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_nig_noFstPeaks.msmc -I 20,21,42,43 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maynig.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig4_cross_noFstPeaks.msmc -I 0,1,18,19,20,21,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maynig.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py maynig4_cross_noFstPeaks.msmc.final.txt maynig4_may_noFstPeaks.msmc.final.txt maynig4_nig_noFstPeaks.msmc.final.txt > combined_maynig4_noFstPeaks_msmc.final.txt
