...
#PBS -N nigpue3                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_nigpue3.stdout
#PBS -e 3.9.1.crosscoal_msmc_nigpue3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue3_nig.msmc -I 10,11,20,21 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue3_pue.msmc -I 26,27,46,47 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.multihetsep.txt \
    $INDIR/LG04.nigpue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue3_cross.msmc -I 10,11,20,21,26,27,46,47 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.multihetsep.txt \
    $INDIR/LG04.nigpue.multihetsep.txt \
...
combineCrossCoal.py nigpue3_cross.msmc.final.txt nigpue3_nig.msmc.final.txt nigpue3_pue.msmc.final.txt > combined_nigpue3_msmc.final.txt
