...
#PBS -N maynig3                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maynig3.stdout
#PBS -e 3.9.1.crosscoal_msmc_maynig3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig3_may.msmc -I 8,9,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig3_nig.msmc -I 30,31,40,41 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig3_cross.msmc -I 8,9,16,17,30,31,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
combineCrossCoal.py maynig3_cross.msmc.final.txt maynig3_may.msmc.final.txt maynig3_nig.msmc.final.txt > combined_maynig3_msmc.final.txt
