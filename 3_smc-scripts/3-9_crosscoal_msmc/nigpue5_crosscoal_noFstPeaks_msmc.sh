...
#PBS -N nFnigpue5                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_nigpue5.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_nigpue5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue5_nig_noFstPeaks.msmc -I 8,9,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue5_pue_noFstPeaks.msmc -I 24,25,44,45 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue5_cross_noFstPeaks.msmc -I 8,9,12,13,24,25,44,45 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py nigpue5_cross_noFstPeaks.msmc.final.txt nigpue5_nig_noFstPeaks.msmc.final.txt nigpue5_pue_noFstPeaks.msmc.final.txt > combined_nigpue5_noFstPeaks_msmc.final.txt
