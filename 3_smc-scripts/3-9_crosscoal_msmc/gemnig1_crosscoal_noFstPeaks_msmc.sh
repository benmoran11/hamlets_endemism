...
#PBS -N nFgemnig1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_gemnig1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_gemnig1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig1_gem_noFstPeaks.msmc -I 2,3,4,5 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig1_nig_noFstPeaks.msmc -I 24,25,28,29 \
    $INDIR/LG01.gemnig.multihetsep.txt \
    $INDIR/LG02.gemnig.multihetsep.txt \
    $INDIR/LG03.gemnig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemnig.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/gemnig1_cross_noFstPeaks.msmc -I 2,3,4,5,24,25,28,29 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.gemnig.multihetsep.txt \
    $INDIR/LG02.gemnig.multihetsep.txt \
    $INDIR/LG03.gemnig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.gemnig.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py gemnig1_cross_noFstPeaks.msmc.final.txt gemnig1_gem_noFstPeaks.msmc.final.txt gemnig1_nig_noFstPeaks.msmc.final.txt > combined_gemnig1_noFstPeaks_msmc.final.txt
