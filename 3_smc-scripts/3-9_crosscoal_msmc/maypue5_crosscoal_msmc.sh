...
#PBS -N maypue5                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maypue5.stdout
#PBS -e 3.9.1.crosscoal_msmc_maypue5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_may.msmc -I 6,7,14,15 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_pue.msmc -I 20,21,40,41 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_cross.msmc -I 6,7,14,15,20,21,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.multihetsep.txt \
    $INDIR/LG04.maypue.multihetsep.txt \
...
combineCrossCoal.py maypue5_cross.msmc.final.txt maypue5_may.msmc.final.txt maypue5_pue.msmc.final.txt > combined_maypue5_msmc.final.txt
