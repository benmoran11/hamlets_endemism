...
#PBS -N nFniguni1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_niguni1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_niguni1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni1_nig_noFstPeaks.msmc -I 14,15,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni1_uni_noFstPeaks.msmc -I 38,39,44,45 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni1_cross_noFstPeaks.msmc -I 14,15,18,19,38,39,44,45 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py niguni1_cross_noFstPeaks.msmc.final.txt niguni1_nig_noFstPeaks.msmc.final.txt niguni1_uni_noFstPeaks.msmc.final.txt > combined_niguni1_noFstPeaks_msmc.final.txt
