...
#PBS -N pueuni3                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_pueuni3.stdout
#PBS -e 3.9.1.crosscoal_msmc_pueuni3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni3_pue.msmc -I 2,3,22,23 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni3_uni.msmc -I 30,31,42,43 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni3_cross.msmc -I 2,3,22,23,30,31,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.multihetsep.txt \
    $INDIR/LG04.pueuni.multihetsep.txt \
...
combineCrossCoal.py pueuni3_cross.msmc.final.txt pueuni3_pue.msmc.final.txt pueuni3_uni.msmc.final.txt > combined_pueuni3_msmc.final.txt
