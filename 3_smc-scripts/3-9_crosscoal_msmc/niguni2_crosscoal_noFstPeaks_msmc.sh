...
#PBS -N nFniguni2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_niguni2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_niguni2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni2_nig_noFstPeaks.msmc -I 4,5,6,7 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni2_uni_noFstPeaks.msmc -I 26,27,28,29 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni2_cross_noFstPeaks.msmc -I 4,5,6,7,26,27,28,29 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py niguni2_cross_noFstPeaks.msmc.final.txt niguni2_nig_noFstPeaks.msmc.final.txt niguni2_uni_noFstPeaks.msmc.final.txt > combined_niguni2_noFstPeaks_msmc.final.txt
