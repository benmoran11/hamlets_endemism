...
#PBS -N maynig1                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_maynig1.stdout
#PBS -e 3.9.1.crosscoal_msmc_maynig1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig1_may.msmc -I 4,5,12,13 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig1_nig.msmc -I 34,35,38,39 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig1_cross.msmc -I 4,5,12,13,34,35,38,39 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.multihetsep.txt \
    $INDIR/LG04.maynig.multihetsep.txt \
...
combineCrossCoal.py maynig1_cross.msmc.final.txt maynig1_may.msmc.final.txt maynig1_nig.msmc.final.txt > combined_maynig1_msmc.final.txt
