...
#PBS -N nFmaynig2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_maynig2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_maynig2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_may_noFstPeaks.msmc -I 2,3,10,11 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_nig_noFstPeaks.msmc -I 24,25,26,27 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maynig.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maynig2_cross_noFstPeaks.msmc -I 2,3,10,11,24,25,26,27 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maynig.multihetsep.txt \
    $INDIR/LG02.maynig.multihetsep.txt \
    $INDIR/LG03.maynig.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maynig.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py maynig2_cross_noFstPeaks.msmc.final.txt maynig2_may_noFstPeaks.msmc.final.txt maynig2_nig_noFstPeaks.msmc.final.txt > combined_maynig2_noFstPeaks_msmc.final.txt
