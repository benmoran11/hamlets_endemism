...
#PBS -N nigpue6                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_nigpue6.stdout
#PBS -e 3.9.1.crosscoal_msmc_nigpue6.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue6_nig.msmc -I 2,3,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue6_pue.msmc -I 34,35,38,39 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.multihetsep.txt \
    $INDIR/LG04.nigpue.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue6_cross.msmc -I 2,3,16,17,34,35,38,39 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.multihetsep.txt \
    $INDIR/LG04.nigpue.multihetsep.txt \
...
combineCrossCoal.py nigpue6_cross.msmc.final.txt nigpue6_nig.msmc.final.txt nigpue6_pue.msmc.final.txt > combined_nigpue6_msmc.final.txt
