...
#PBS -N nFpueuni5                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_pueuni5.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_pueuni5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni5_pue_noFstPeaks.msmc -I 0,1,20,21 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni5_uni_noFstPeaks.msmc -I 36,37,46,47 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/pueuni5_cross_noFstPeaks.msmc -I 0,1,20,21,36,37,46,47 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.pueuni.multihetsep.txt \
    $INDIR/LG02.pueuni.multihetsep.txt \
    $INDIR/LG03.pueuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.pueuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py pueuni5_cross_noFstPeaks.msmc.final.txt pueuni5_pue_noFstPeaks.msmc.final.txt pueuni5_uni_noFstPeaks.msmc.final.txt > combined_pueuni5_noFstPeaks_msmc.final.txt
