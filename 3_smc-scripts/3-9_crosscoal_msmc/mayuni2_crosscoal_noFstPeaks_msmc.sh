...
#PBS -N nFmayuni2                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_mayuni2.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_mayuni2.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_may_noFstPeaks.msmc -I 2,3,10,11 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_uni_noFstPeaks.msmc -I 22,23,24,25 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni2_cross_noFstPeaks.msmc -I 2,3,10,11,22,23,24,25 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py mayuni2_cross_noFstPeaks.msmc.final.txt mayuni2_may_noFstPeaks.msmc.final.txt mayuni2_uni_noFstPeaks.msmc.final.txt > combined_mayuni2_noFstPeaks_msmc.final.txt
