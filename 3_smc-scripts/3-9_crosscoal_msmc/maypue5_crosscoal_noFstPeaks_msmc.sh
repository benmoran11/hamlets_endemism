...
#PBS -N nFmaypue5                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_maypue5.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_maypue5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_may_noFstPeaks.msmc -I 6,7,14,15 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_pue_noFstPeaks.msmc -I 20,21,40,41 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue5_cross_noFstPeaks.msmc -I 6,7,14,15,20,21,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py maypue5_cross_noFstPeaks.msmc.final.txt maypue5_may_noFstPeaks.msmc.final.txt maypue5_pue_noFstPeaks.msmc.final.txt > combined_maypue5_noFstPeaks_msmc.final.txt
