...
#PBS -N nFmayuni5                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_mayuni5.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_mayuni5.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni5_may_noFstPeaks.msmc -I 6,7,14,15 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni5_uni_noFstPeaks.msmc -I 32,33,42,43 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/mayuni5_cross_noFstPeaks.msmc -I 6,7,14,15,32,33,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.mayuni.multihetsep.txt \
    $INDIR/LG02.mayuni.multihetsep.txt \
    $INDIR/LG03.mayuni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.mayuni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py mayuni5_cross_noFstPeaks.msmc.final.txt mayuni5_may_noFstPeaks.msmc.final.txt mayuni5_uni_noFstPeaks.msmc.final.txt > combined_mayuni5_noFstPeaks_msmc.final.txt
