...
#PBS -N nFnigpue1                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_nigpue1.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_nigpue1.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue1_nig_noFstPeaks.msmc -I 14,15,18,19 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue1_pue_noFstPeaks.msmc -I 28,29,40,41 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/nigpue1_cross_noFstPeaks.msmc -I 14,15,18,19,28,29,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.nigpue.multihetsep.txt \
    $INDIR/LG02.nigpue.multihetsep.txt \
    $INDIR/LG03.nigpue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.nigpue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py nigpue1_cross_noFstPeaks.msmc.final.txt nigpue1_nig_noFstPeaks.msmc.final.txt nigpue1_pue_noFstPeaks.msmc.final.txt > combined_nigpue1_noFstPeaks_msmc.final.txt
