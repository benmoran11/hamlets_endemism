...
#PBS -N niguni4                    # Name des Batch-Jobs
...
#PBS -o 3.9.1.crosscoal_msmc_niguni4.stdout
#PBS -e 3.9.1.crosscoal_msmc_niguni4.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni4_nig.msmc -I 0,1,22,23 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni4_uni.msmc -I 24,25,40,41 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni4_cross.msmc -I 0,1,22,23,24,25,40,41 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.multihetsep.txt \
    $INDIR/LG04.niguni.multihetsep.txt \
...
combineCrossCoal.py niguni4_cross.msmc.final.txt niguni4_nig.msmc.final.txt niguni4_uni.msmc.final.txt > combined_niguni4_msmc.final.txt
