...
#PBS -N nFmaypue3                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_maypue3.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_maypue3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_may_noFstPeaks.msmc -I 8,9,16,17 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_pue_noFstPeaks.msmc -I 22,23,42,43 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/maypue3_cross_noFstPeaks.msmc -I 8,9,16,17,22,23,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.maypue.multihetsep.txt \
    $INDIR/LG02.maypue.multihetsep.txt \
    $INDIR/LG03.maypue.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.maypue.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py maypue3_cross_noFstPeaks.msmc.final.txt maypue3_may_noFstPeaks.msmc.final.txt maypue3_pue_noFstPeaks.msmc.final.txt > combined_maypue3_noFstPeaks_msmc.final.txt
