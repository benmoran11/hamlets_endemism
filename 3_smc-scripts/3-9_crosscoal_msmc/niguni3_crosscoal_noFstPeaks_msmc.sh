...
#PBS -N nFniguni3                    # Name des Batch-Jobs
...
#PBS -o 3.9.2.crosscoal_msmc_noFstPeaks_niguni3.stdout
#PBS -e 3.9.2.crosscoal_msmc_noFstPeaks_niguni3.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni3_nig_noFstPeaks.msmc -I 10,11,20,21 \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni3_uni_noFstPeaks.msmc -I 30,31,42,43 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/niguni3_cross_noFstPeaks.msmc -I 10,11,20,21,30,31,42,43 -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.niguni.multihetsep.txt \
    $INDIR/LG02.niguni.multihetsep.txt \
    $INDIR/LG03.niguni.noFstPeaks.multihetsep.txt \
    $INDIR/LG04.niguni.noFstPeaks.multihetsep.txt \
...
combineCrossCoal.py niguni3_cross_noFstPeaks.msmc.final.txt niguni3_nig_noFstPeaks.msmc.final.txt niguni3_uni_noFstPeaks.msmc.final.txt > combined_niguni3_noFstPeaks_msmc.final.txt
