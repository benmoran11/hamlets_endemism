...
#PBS -o 3.7.1.msmc_XXrunXX.stdout
#PBS -e 3.7.1.msmc_XXrunXX.stderr
...
msmc_2.0.0_linux64bit -m 0.00254966 -t 8 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/XXrunXX.msmc2 -I 0,1,2,3,4,5,6,7 \
    $INDIR/LG01.XXrunXX.multihetsep.txt \
    $INDIR/LG02.XXrunXX.multihetsep.txt \
    $INDIR/LG03.XXrunXX.multihetsep.txt \
    $INDIR/LG04.XXrunXX.multihetsep.txt \
    $INDIR/LG05.XXrunXX.multihetsep.txt \
    $INDIR/LG06.XXrunXX.multihetsep.txt \
    $INDIR/LG07.XXrunXX.multihetsep.txt \
    $INDIR/LG08.XXrunXX.multihetsep.txt \
    $INDIR/LG09.XXrunXX.multihetsep.txt \
    $INDIR/LG10.XXrunXX.multihetsep.txt \
    $INDIR/LG11.XXrunXX.multihetsep.txt \
    $INDIR/LG12.XXrunXX.multihetsep.txt \
    ...
    $INDIR/LG17.XXrunXX.multihetsep.txt \
    ...
    $INDIR/LG23.XXrunXX.multihetsep.txt \
