...
#PBS -o 3.9.1.crosscoal_msmc_XXrunXX.stdout
#PBS -e 3.9.1.crosscoal_msmc_XXrunXX.stderr
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/XXrunXX_XXspec1XX.msmc -I XXhap1XX,XXhap2XX,XXhap3XX,XXhap4XX \
    $INDIR/LG01.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG02.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG03.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG04.XXspec1XXXXspec2XX.multihetsep.txt \
    ...
    $INDIR/LG08.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG09.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG10.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG11.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG12.XXspec1XXXXspec2XX.multihetsep.txt \
    ...
    $INDIR/LG17.XXspec1XXXXspec2XX.multihetsep.txt \
    ...
    $INDIR/LG23.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG24.XXspec1XXXXspec2XX.multihetsep.txt
echo done

msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/XXrunXX_XXspec2XX.msmc -I XXhap5XX,XXhap6XX,XXhap7XX,XXhap8XX \
    $INDIR/LG01.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG02.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG03.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG04.XXspec1XXXXspec2XX.multihetsep.txt \
...
msmc_2.0.0_linux64bit -m 0.00255863 -t 24 -p 1*2+25*1+1*2+1*3 -o $OUTDIR/XXrunXX_cross.msmc -I XXhap1XX,XXhap2XX,XXhap3XX,XXhap4XX,XXhap5XX,XXhap6XX,XXhap7XX,XXhap8XX -P 0,0,0,0,1,1,1,1 \
    $INDIR/LG01.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG02.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG03.XXspec1XXXXspec2XX.multihetsep.txt \
    $INDIR/LG04.XXspec1XXXXspec2XX.multihetsep.txt \
...
combineCrossCoal.py XXrunXX_cross.msmc.final.txt XXrunXX_XXspec1XX.msmc.final.txt XXrunXX_XXspec2XX.msmc.final.txt > combined_XXrunXX_msmc.final.txt
